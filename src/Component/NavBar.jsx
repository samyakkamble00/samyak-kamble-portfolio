...
import { FaBars , FaTimes} from "react-icons/fa"; // Import FaBars if it's a React component
...
const NavBar = () => {
  ...
  const links = [
    ...
    { id: 2, link: "about" },
    { id: 3, link: "portfolio" },
    { id: 4, link: "techinicalskill" },
    { id: 5, link:  "contact"},
  ];
  return (
    <div className="flex justify-between items-center w-full h-20 fixed px-4 bg-black m-auto">
      <div>
        <h1 className="text-5xl ml-2">Samyak</h1>
      </div>
